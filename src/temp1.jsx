    ...
    <>
      ...
      <div className="second-container">
        ...
        >
          <div style={{ display: "flex", alignItems: "center" }}>
            <FontAwesomeIcon
              icon={faHeart}
              size="lg"
              style={{ color: "violet", height: "100%", position: "absolute" }}
            />
            <h5
              style={{
                color: "#fff",
          ...
          <div style={{ position: "absolute", marginBottom: 5 }}>
            ...
            />
            <span>
              <h6 style={{ color: "white", marginLeft: 70, marginTop: 50 }}>
                271 songs
              </h6>
            </span>
          </div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center" }}>
            {
              <FontAwesomeIcon
                icon={faMusic}
                size="lg"
                style={{ color: "white", height: "100%", position: "absolute" }}
              />
            }
          ...
          <div style={{ position: "absolute", marginBottom: 5 }}>
            <span>
              <h6 style={{ color: "white", marginLeft: 50, marginTop: 60 }}>
                pranshu
              </h6>
            </span>
          </div>
